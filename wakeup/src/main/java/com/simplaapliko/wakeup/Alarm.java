...
public class Alarm implements Parcelable {
    ...
    public boolean isKeepOnInit() {
        return mKeepOnInit;
    }

    public void setKeepOnInit(boolean keepOnInit) {
        mKeepOnInit = keepOnInit;
    }
